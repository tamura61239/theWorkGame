...
VS_OUT main(float4 position : POSITION, float3 scale : SCALE, float3 angle : ANGLE, float4 color : COLOR, float3 velocity : VELOCITY, float3 accel:ACCEL,float life:LIFE)
{
	VS_OUT vout;
